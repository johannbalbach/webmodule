...
class ant{
    ...
    iteration()
    {
        ...
        if (this.IsThereFood)
        {
            ...
            //if (Cells[this.x][this.y].foodPheromoneDistance > this.Distance)
                Cells[this.x][this.y].foodPheromoneDistance = this.Distance;
        }
        else
        {
            if(Cells[this.x][this.y].homePheromone < 10)
                Cells[this.x][this.y].homePheromone += 1;
            //if (Cells[this.x][this.y].homePheromoneDistance > this.Distance)
